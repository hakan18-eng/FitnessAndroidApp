...
public class Workout_Start extends AppCompatActivity {
    ...
    private String getCategoryFromExercise(String name) {
        ...
        if (lowerName.contains("squat") || lowerName.contains("leg") || lowerName.contains("calf") ||
                lowerName.contains("lunge") || lowerName.contains("adductor")) {
            return "Legs";
        } else if (lowerName.contains("glute") || lowerName.contains("bridge") || lowerName.contains("donkey")
                || lowerName.contains("deadlift")) {
            return "Gluteus";
        } else if (lowerName.contains("treadmill") || lowerName.contains("cycling") ||
                lowerName.contains("climber") || lowerName.contains("sprint") || lowerName.contains("cardio")) {
            return "Cardio";
        } else {
            return "Upper Body";
        }
